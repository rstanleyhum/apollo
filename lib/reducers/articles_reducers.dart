...
Map<String, Article> articleReducer(Map<String, Article> state, dynamic action) {
...
Map<String, Article> addArticlesFromData(Map<String, Article> state, AddArticlesFromDataAction action) {
